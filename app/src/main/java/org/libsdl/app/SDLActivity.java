...
*/
    ...
    public static final boolean mHasMultiWindow = (Build.VERSION.SDK_INT >=
        24 /* Android 7.0 (N) */);
    ...
    protected String getMainSharedObject() {
        ...
        return (
            getContext().getApplicationInfo().nativeLibraryDir + "/" + library
        );
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!mBrokenLibraries) {
            String expected_version =
                String.valueOf(SDL_MAJOR_VERSION) +
                "." +
            ...
            if (!version.equals(expected_version)) {
                mBrokenLibraries = true;
                errorMsgBrokenLib =
                    "SDL C/Java version mismatch (expected " +
                    expected_version +
                    ", got " +
                    version +
                    ")";
        ...
        {
            int run_count =
                SDLActivity.nativeCheckSDLThreadCounter(); /* get and increment a native counter */
            if (run_count != 0) {
                boolean allow_recreate =
                    SDLActivity.nativeAllowRecreateActivity();
                if (allow_recreate) {
                    Log.v(
                        TAG,
                        "activity re-created // run_count: " + run_count
                    );
                } else {
        ...
        SDLActivity.nativeSetNaturalOrientation(
            SDLActivity.getNaturalOrientation()
        );
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (
            mCurrentLocale == null || !mCurrentLocale.equals(newConfig.locale)
        ) {
    ...
    public void onBackPressed() {
        ...
        //
        boolean trapBack = SDLActivity.nativeGetHintBoolean(
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.arg1) {
                ...
                case COMMAND_CHANGE_WINDOW_STYLE:
                    if (
                        Build.VERSION.SDK_INT >= 19 /* Android 4.4 (KITKAT) */
                    ) {
                        if (context instanceof Activity) {
                            Window window = ((Activity) context).getWindow();
                            if (window != null) {
                                if (
                                    (msg.obj instanceof Integer) &&
                                    ((Integer) msg.obj != 0)
                                ) {
                                    int flags =
                ...
                default:
                    if (
                        (context instanceof SDLActivity) &&
        ...
        if (Build.VERSION.SDK_INT >= 19 /* Android 4.4 (KITKAT) */) {
            if (command == COMMAND_CHANGE_WINDOW_STYLE) {
                ...
                if (data instanceof Integer) {
                    ...
                    boolean bFullscreenLayout = ((realMetrics.widthPixels ==
                            mSurface.getWidth()) &&
    ...
    public static native void onNativePen(
        int penId,
        int button,
        int action,
        float x,
    ...
    public static native boolean nativeGetHintBoolean(
        String name,
    ...
    public static native void onNativeInsetsChanged(
        int left,
        int right,
        int top,
        int bottom
    ...
    public static native void onNativeFileDialog(
        int requestCode,
        String[] filelist,
        int filter
    );
    ...
    public void setOrientationBis(
        ...
        boolean contains_Portrait =
            hint.contains("Portrait ") || hint.endsWith("Portrait");
    ...
    public static boolean isScreenKeyboardShown() {
        ...
        InputMethodManager imm =
            (InputMethodManager) SDL.getContext().getSystemService(
                Context.INPUT_METHOD_SERVICE
            );
    ...
    public static boolean supportsRelativeMouse() {
        ...
        //
        if (
            Build.VERSION.SDK_INT < 27 /* Android 8.1 (O_MR1) */ && isDeXMode()
        ) {
            return false;
        }
    ...
    public static boolean isAndroidTV() {
        UiModeManager uiModeManager =
            (UiModeManager) getContext().getSystemService(UI_MODE_SERVICE);
        if (
        ...
        if (
            Build.MANUFACTURER.equals("MINIX") && Build.MODEL.equals("NEO-U1")
        ) {
            return true;
        }
        if (
            Build.MANUFACTURER.equals("Amlogic") && Build.MODEL.equals("X96-W")
        ) {
            return true;
        }
        if (
            Build.MANUFACTURER.equals("Amlogic") && Build.MODEL.startsWith("TV")
        ) {
            return true;
        }
        return false;
    ...
    public static boolean isVRHeadset() {
        if (
            Build.MANUFACTURER.equals("Oculus") &&
            Build.MODEL.startsWith("Quest")
        ) {
            return true;
        }
    ...
    public static double getDiagonal() {
        ...
        return Math.sqrt(
            (dWidthInches * dWidthInches) + (dHeightInches * dHeightInches)
        );
    }
    ...
    public static boolean isDeXMode() {
        ...
        try {
            final Configuration config = getContext()
                .getResources()
                .getConfiguration();
     ...
     * This method is called by SDL using JNI.
     */
    public static boolean showTextInput(
        int input_type,
        int x,
        int y,
        int w,
        ...
        return mSingleton.commandHandler.post(
            new ShowTextInputTask(input_type, x, y, w, h)
        );
    }
    ...
    public static void initTouch() {
        ...
        for (int id : ids) {
            ...
            if (
                device != null &&
                ((device.getSources() & InputDevice.SOURCE_TOUCHSCREEN) ==
    ...
    public static boolean showToast(
        ...
        try {
            ...
            mSingleton.runOnUiThread(
                new OneShotTask(message, duration, gravity, xOffset, yOffset)
            );
        } catch (Exception ex) {
            return false;
        }
    ...
    public static int openFileDescriptor(String uri, String mode)
        ...
        try {
            ParcelFileDescriptor pfd = mSingleton
                .getContentResolver()
                .openFileDescriptor(Uri.parse(uri), mode);
     ...
     * This method is called by SDL using JNI.
     */
    public static boolean showFileDialog(
        String[] filters,
...
class SDLMain implements Runnable {
    ...
    public void run() {
        ...
        if (
            ...
            !SDLActivity.mSingleton.isFinishing()
        ) {
...
class SDLClipboardHandler
    ...
    SDLClipboardHandler() {
        mClipMgr = (ClipboardManager) SDL.getContext().getSystemService(
